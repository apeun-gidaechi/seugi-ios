...
public protocol StompClientDelegate: AnyObject {
    func stompClient(client: StompClient!, didReceiveMessageWithJSONBody jsonBody: AnyObject?, akaStringBody stringBody: String?, withHeader header:[String:String]?, withDestination destination: String)
...
@objcMembers
public class StompClient: NSObject, SRWebSocketDelegate {
    ...
    public func openSocketWithURLRequest(request: NSURLRequest, delegate: StompClientDelegate, connectionHeaders: [String: String]? = nil) {
...
//            socket?.send(StompCommands.commandPing)
    ...
    public func reconnect(request: NSURLRequest, delegate: StompClientDelegate, connectionHeaders: [String: String] = [String: String](), time: Double = 1.0, exponentialBackoff: Bool = true){
    ...
    private func reconnectLogic(request: NSURLRequest, delegate: StompClientDelegate, connectionHeaders: [String: String] = [String: String]()){
